...
//    private static final String MEDIA_URL = Paths.get("/media/revo/revo", "w.mp3").toUri().toString();
    ...
    private void init(Stage primaryStage) {
        ...
        mediaPlayer = new MediaPlayer(new Media("file:///media/revo/revo/w.mp3"));
